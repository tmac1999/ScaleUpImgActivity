...
public class ImagePreviewActivity extends Activity implements ViewTreeObserver.OnPreDrawListener {
    ...
    public static void enterActivity(Activity fromActivity, List<ImageInfo> imageInfoList, int currentItemIndex, ImagePreviewAdapter.ImageLoader imageLoader) {
        ImagePreviewAdapter.setImageLoader(imageLoader);
        ...
        bundle.putInt(ImagePreviewActivity.CURRENT_ITEM, currentItemIndex);
        intent.putExtras(bundle);
        fromActivity.startActivity(intent);
        ((Activity) fromActivity).overridePendingTransition(0, 0);
    }
